...
const HomeClient = ({ email }: { email: string }) => {
    ...
    const features=[
        ...
        {
            title:"Always Online",
            desc:"Your customers can reach you 24/7."
        }
    ]
        ...
        <div className='min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden'>
            ...
            >
                <div className='max-x-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    ...
                    {email ? <div className='relative' ref={popupRef}>
                        ...
                        <AnimatePresence>
                            {open && (
                                <motion.div
                                    ...
                                    <button className='w-full text-left block px-4 py-3 text-sm text-red-600
                        ...
                        className='px-5 py-2 rounded-full bg-zinc-800 text-white text-sm font-medium
                        hover:bg-black transition disabled:opacity-60 flex items-center gap-2
                        cursor-pointer' onClick={handleLogin} disabled={loading}>
            ...
            <section className='pt-36 pb-28 px-6'>
                <div className='max-w-6xl mx-auto grid grid-cols-1
                                md:grid-cols-2 gap-20 items-center'>
                    <motion.div
                        ...
                        <div className='mt-10 flex gap-4 text-xl'>
                            {email ? <button
                                className='px-7 py-3 rounded-xl bg-zinc-800
                                        text-white font-medium hover:bg-black 
                                        transition disabled:opacity-60' onClick={()=>navigate.push('/dashboard')}>
                                Go to Dashboard
                            </button> : <button
                                className='px-7 py-3 rounded-xl bg-zinc-800
                                        text-white font-medium hover:bg-black 
                    ...
                    <motion.div
                        ...
                        <div className='rounded-2xl bg-white shadow-2xl
                                        border border-zinc-200 p-6'>
                            <div className='text-sm text-zinc-500 mb-3'>
                                Live Chat Preview
                            </div>
                            <div className='space-y-2'>
                                <div className='bg-black text-white rounded-lg px-4 py-2 text-sm ml-auto w-fit'>Do you offer COD?</div>
                                <div className='bg-zinc-100 rounded-lg px-4 py-2 text-sm w-fit'>Yes, We do!</div>
                            </div>
                            <motion.div
                            animate={{y:[0,12,0]}}
